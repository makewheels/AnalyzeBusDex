...
/* compiled from: Utils */
/* renamed from: com.autonavi.tbt.q */
public class C0630q {
    /* renamed from: a */
    public static String m4944a(String str) {
        ...
        try {
            ...
            th.printStackTrace();
            ae.m4671a(th, "Utils", "sortParams");
        }
        return str;
    }

    /* renamed from: a */
    public static byte[] m4946a(byte[] bArr) {
        try {
            return C0630q.m4950e(bArr);
        } catch (Throwable e) {
            ae.m4671a(e, "Utils", "gZip");
            e.printStackTrace();
            return new byte[0];
        } catch (Throwable e2) {
            ae.m4671a(e2, "Utils", "gZip");
            e2.printStackTrace();
            return new byte[0];
        }
    }
    ...
    /* renamed from: a */
    static PublicKey m4945a(Context context) throws CertificateException, InvalidKeySpecException, NoSuchAlgorithmException, NullPointerException, IOException {
        KeyFactory instance;
        Throwable th;
    ...
    /* renamed from: b */
    static String m4947b(byte[] bArr) {
        try {
            return C0630q.m4949d(bArr);
        } catch (Throwable th) {
            ae.m4671a(th, "Utils", "HexString");
            th.printStackTrace();
            return null;
        }
    }
    ...
    /* renamed from: c */
    static String m4948c(byte[] bArr) {
        try {
            return C0630q.m4949d(bArr);
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    /* renamed from: d */
    private static String m4949d(byte[] bArr) {
    ...
    /* renamed from: e */
    private static byte[] m4950e(byte[] bArr) throws IOException, Throwable {
        IOException e;
        Throwable th;
        Throwable th2;
        byte[] bArr2 = null;
