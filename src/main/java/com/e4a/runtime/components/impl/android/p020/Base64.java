...
/* renamed from: com.e4a.runtime.components.impl.android.支付宝类库.Base64 */
public final class Base64 {
    ...
    public static String encode(byte[] bArr) {
        ...
        while (i4 < i3) {
            ...
            length = (b3 & SIGN) == 0 ? (byte) (b3 >> 6) : (byte) ((b3 >> 6) ^ 252);
            int i8 = i5 + 1;
    ...
    public static byte[] decode(String str) {
        ...
        int removeWhiteSpace = Base64.removeWhiteSpace(toCharArray);
        ...
        if (Base64.isData(c2) && Base64.isData(c7)) {
            ...
            obj[i2] = (byte) ((b7 << 6) | b8);
            return obj;
        } else if (Base64.isPad(c2) && Base64.isPad(c7)) {
            if ((b6 & 15) != 0) {
                return null;
            }
            r0 = new byte[((i4 * 3) + 1)];
    ...
    private static int removeWhiteSpace(char[] cArr) {
        ...
        if (cArr != null) {
            ...
            while (i2 < length) {
                int i3;
                if (Base64.isWhiteSpace(cArr[i2])) {
                    i3 = i;
                } else {
                    i3 = i + 1;
                    cArr[i] = cArr[i2];
