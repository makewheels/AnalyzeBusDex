...
public final class RSSExpandedReader extends AbstractRSSReader {
    private static final int[] EVEN_TOTAL_SUBSET = new int[]{4, 20, 52, ErrorCode.WRITE_DISK_ERROR, ErrorCode.APK_INVALID};
    ...
    private static final int[][] WEIGHTS = new int[][]{new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, 143, 7, 21, 63}, new int[]{189, 145, 13, 39, 117, 140, ErrorCode.DEXOPT_EXCEPTION, ErrorCode.UNZIP_DIR_ERROR}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, 197, 169, 85, 44, 132}, new int[]{185, 133, 188, 142, 4, 12, 36, ErrorCode.VERIFY_ERROR}, new int[]{ErrorCode.DOWNLOAD_FILE_CONTENTLENGTH_NOT_MATCH, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, 138, ErrorCode.APK_VERSION_ERROR, 187, 139, ErrorCode.UNZIP_IO_ERROR, 196, 166}, new int[]{76, 17, 51, 153, 37, ErrorCode.NETWORK_NOT_WIFI_ERROR, 122, 155}, new int[]{43, 129, 176, ErrorCode.FILE_DELETED, ErrorCode.UNKNOWN_ERROR, ErrorCode.NONEEDTODOWN_ERROR, 119, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{ErrorCode.FILE_RENAME_ERROR, 116, 137, 200, 178, ErrorCode.DOWNLOAD_OVER_FLOW, 125, 164}, new int[]{70, ErrorCode.ROM_NOT_ENOUGH, ErrorCode.EXCEED_DEXOPT_RETRY_NUM, ErrorCode.APK_PATH_ERROR, 184, 130, 179, 115}, new int[]{134, 191, 151, 31, 93, 68, ErrorCode.APK_INVALID, 190}, new int[]{148, 22, 66, 198, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, 192, 154, 40}, new int[]{ErrorCode.DOWNLOAD_HAS_LOCAL_TBS_ERROR, 149, 25, 75, 14, 42, 126, 167}, new int[]{79, 26, 78, 23, 69, ErrorCode.UNZIP_OTHER_ERROR, 199, 175}, new int[]{103, 98, 83, 38, 114, 131, 182, 124}, new int[]{161, 61, 183, 127, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, 135, 194, 160, 58, 174, 100, 89}};
    ...
    private boolean checkChecksum() {
        ...
        if (((s - 4) * ErrorCode.EXCEED_COPY_RETRY_NUM) + (checksum % ErrorCode.EXCEED_COPY_RETRY_NUM) == checkCharacter.getValue()) {
            return true;
        }
        return false;
    }
