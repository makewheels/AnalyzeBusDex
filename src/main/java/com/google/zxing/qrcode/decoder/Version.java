...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(1, ErrorCode.VERIFY_ERROR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(4, ErrorCode.UNKNOWN_ERROR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(1, ErrorCode.UNKNOWN_ERROR), new ECB(5, ErrorCode.VERIFY_ERROR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, ErrorCode.DOWNLOAD_HAS_LOCAL_TBS_ERROR), new ECB(1, 121));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, ErrorCode.DOWNLOAD_FILE_CONTENTLENGTH_NOT_MATCH), new ECB(4, 114));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, ErrorCode.UNKNOWN_ERROR), new ECB(5, ErrorCode.VERIFY_ERROR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(2, ErrorCode.NETWORK_NOT_WIFI_ERROR), new ECB(7, ErrorCode.DOWNLOAD_OVER_FLOW));
        ...
        iArr = new int[]{6, 28, 54, 80, ErrorCode.FILE_DELETED};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, ErrorCode.NONEEDTODOWN_ERROR};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(8, ErrorCode.FILE_DELETED), new ECB(4, ErrorCode.UNKNOWN_ERROR));
        ...
        iArr = new int[]{6, 26, 52, 78, ErrorCode.WRITE_DISK_ERROR, 130};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 56, 82, ErrorCode.VERIFY_ERROR, 134};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 34, 60, 86, ErrorCode.DOWNLOAD_OVER_FLOW, 138};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, ErrorCode.FILE_DELETED, 132, 158};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, ErrorCode.NONEEDTODOWN_ERROR, 136, 162};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 54, 82, ErrorCode.NONEEDTODOWN_ERROR, 138, 166};
        eCBlocksArr = new ECBlocks[4];
