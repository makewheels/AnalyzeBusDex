...
public class BaseImageDecoder implements ImageDecoder {
    ...
    public Bitmap decode(ImageDecodingInfo decodingInfo) throws IOException {
        ...
        try {
            ...
            C1004L.m7343e(ERROR_CANT_DECODE_IMAGE, decodingInfo.getImageKey());
    ...
    private boolean canDefineExifParams(String imageUri, String mimeType) {
        return VERSION.SDK_INT >= 5 && "image/jpeg".equalsIgnoreCase(mimeType) && Scheme.ofUri(imageUri) == Scheme.FILE;
    }
    ...
    L_0x002d:
        ...
        r7 = 0;
        r6[r7] = r9;
        com.nostra13.universalimageloader.utils.C1004L.m7347w(r5, r6);
        goto L_0x0018;
        */
    ...
    protected Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo decodingInfo) {
        ...
        if (scale > 1 && this.loggingEnabled) {
            C1004L.m7342d(LOG_SUBSAMPLE_IMAGE, imageSize, imageSize.scaleDown(scale), Integer.valueOf(scale), decodingInfo.getImageKey());
        }
        ...
        if (scaleType == ImageScaleType.EXACTLY || scaleType == ImageScaleType.EXACTLY_STRETCHED) {
            ...
            if (Float.compare(scale, 1.0f) != 0) {
                ...
                if (this.loggingEnabled) {
                    C1004L.m7342d(LOG_SCALE_IMAGE, srcSize, srcSize.scale(scale), Float.valueOf(scale), decodingInfo.getImageKey());
                }
            }
        }
        if (flipHorizontal) {
            ...
            if (this.loggingEnabled) {
                C1004L.m7342d(LOG_FLIP_IMAGE, decodingInfo.getImageKey());
            }
        }
        if (rotation != 0) {
            m.postRotate((float) rotation);
            if (this.loggingEnabled) {
                C1004L.m7342d(LOG_ROTATE_IMAGE, Integer.valueOf(rotation), decodingInfo.getImageKey());
            }
        }
