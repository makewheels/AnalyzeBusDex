...
public class C064710 extends C0645Impl {
    ...
    public void $define() {
        ...
        this.f39611.mo782((int) C0893_算术运算.m6855(ByteVariant.getByteVariant((byte) 0).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f39611.mo804((int) C0893_算术运算.m6855(ByteVariant.getByteVariant((byte) 0).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f39611.mo780((int) C0893_算术运算.m6855(ByteVariant.getByteVariant((byte) 1).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f39611.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.908d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        ...
        this.f39601.mo782((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.006d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f39601.mo804((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.004d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f39601.mo780((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.083d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f39601.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.046d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
