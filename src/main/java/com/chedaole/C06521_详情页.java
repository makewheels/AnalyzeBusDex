...
public class C06521_详情页 extends C0645Impl {
    ...
    @SimpleDataElement
    /* renamed from: 临时 */
    public String f4045 = bi_常量类.f6358b_空串;
    @SimpleDataElement
    /* renamed from: 事件监听器1 */
    public C0797 f40461;
    @SimpleDataElement
    ...
    @SimpleDataElement
    /* renamed from: 预计时间 */
    public String f4125 = bi_常量类.f6358b_空串;
    ...
    public void $define() {
        ...
        this.f41181.mo887(bi_常量类.f6358b_空串);
    ...
    public String m5239N(String 数据) {
        ...
        for (int x = 0; x <= C0890_文本操作.m6817_获取字符串长度(数据); x = IntegerVariant.getIntegerVariant(x).add(ByteVariant.getByteVariant((byte) 1)).getInteger()) {
            if (!C0890_文本操作.m6814_截取子串(数据, x, 1).equals(null)) {
                if (this.f4045.equals(bi_常量类.f6358b_空串)) {
        ...
        try {
            ...
            for (int i = 0; i <= integer; i++) {
                if (this.f4073 != i) {
                    ...
                    ((C0739) this.f4113.m5455(i).getObject()).mo1139(bi_常量类.f6358b_空串);
                    站名.mo889(-16777216);
                    if (IntegerVariant.getIntegerVariant(C0894.m6884()).cmp(ShortVariant.getShortVariant((short) 860)) < 0) {
                        站名.mo1049(10.0f);
                    } else {
    ...
    public void m52571$() {
        ...
        try {
            ...
            this.f408916.mo895(C0890_文本操作.m6808(C0890_文本操作.m6819(this.f408411.mo894(), "路", bi_常量类.f6358b_空串)));
    ...
    public void m52351$_底部五个按钮点击事件(int 项目索引) {
        ...
        if (项目索引 == 0) {
            ...
            if (this.zz_城市.equals("daqing")) {
                ...
                C0889_文件操作.m6781_写出文本文件(((C0852_存储卡类.m6665_取存储卡路径() + "/cityisba/") + this.zz_城市) + "/805.html", C0890_文本操作.m6819(C0890_文本操作.m6819(C0890_文本操作.m6819(C0890_文本操作.m6819(资源1, "haimalu", C0890_文本操作.m6819(C0890_文本操作.m6819(C0890_文本操作.m6819(C0890_文本操作.m6819(this.f4117_线路名, "h", "环"), "k", "快"), "m", bi_常量类.f6358b_空串), "环", "环线巴士")), "路线", this.f4117_线路名), "方向", 方向), "大庆", this.zz_城市), "UTF-8");
    ...
    public void m52404_详情页底部收藏按钮() {
        ...
        if (IntegerVariant.getIntegerVariant(C0890_文本操作.m6821(this.f4117_线路名, "101", 0)).cmp(ByteVariant.getByteVariant((byte) 0)) > 0) {
            ...
            C0889_文件操作.m6781_写出文本文件(((C0852_存储卡类.m6665_取存储卡路径() + "/cityisba/") + this.zz_城市) + "/SC.txt", ((C0890_文本操作.m6819(v, ("y" + 线路1) + "z", bi_常量类.f6358b_空串) + "y") + 线路1) + "z", "UTF-8");
        }
    }
