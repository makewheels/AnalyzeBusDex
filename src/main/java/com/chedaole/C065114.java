...
public class C065114 extends C0645Impl {
    ...
    @SimpleDataElement
    /* renamed from: 图片框1 */
    public C0739_图片框 f40361;
    @SimpleDataElement
    /* renamed from: 图片框2 */
    public C0739_图片框 f40372;
    @SimpleDataElement
    /* renamed from: 图片框3 */
    public C0739_图片框 f40383;
    @SimpleDataElement
    /* renamed from: 时钟1 */
    public C0696 f40391;
    @SimpleDataElement
    ...
    public void $define() {
        ...
        this.f40401.mo782((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.017d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40401.mo804((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.093d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f40401.mo780((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.917d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40401.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.805d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        ...
        this.f40372.mo782((int) C0893_算术运算.m6855(ByteVariant.getByteVariant((byte) 0).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40372.mo804((int) C0893_算术运算.m6855(ByteVariant.getByteVariant((byte) 0).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f40372.mo780((int) C0893_算术运算.m6855(ByteVariant.getByteVariant((byte) 1).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40372.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.083d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        ...
        this.f40361.mo782((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.885d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40361.mo804((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.015d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f40361.mo780((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.083d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40361.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.046d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        ...
        this.f40383.mo782((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.023d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40383.mo804((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.014d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f40383.mo780((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.083d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f40383.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.046d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
