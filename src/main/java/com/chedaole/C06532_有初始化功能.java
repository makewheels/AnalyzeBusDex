...
public class C06532_有初始化功能 extends C0645Impl {
    ...
    public void $define() {
        ...
        this.f41351.mo782((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.25d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f41351.mo804((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.165d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
        this.f41351.mo780((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.383d).mul(IntegerVariant.getIntegerVariant(C0894.m6882()))));
        this.f41351.mo806((int) C0893_算术运算.m6855(DoubleVariant.getDoubleVariant(0.299d).mul(IntegerVariant.getIntegerVariant(C0894.m6884() - C0894.m6885()))));
