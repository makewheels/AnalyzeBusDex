...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                e.printStackTrace();
                C1052b.m7515b(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            C1052b.m7515b(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }
        ...
        private static String pathOldToNew(String str) {
            ...
            C1052b.m7515b(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
            return str;
        }
    ...
    final boolean checkArgs() {
        if (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) {
            C1052b.m7515b(TAG, "checkArgs fail, thumbData should not be null when send emoji");
            return false;
        } else if (this.thumbData != null && this.thumbData.length > 32768) {
            C1052b.m7515b(TAG, "checkArgs fail, thumbData is invalid");
            return false;
        } else if (this.title != null && this.title.length() > TITLE_LENGTH_LIMIT) {
            C1052b.m7515b(TAG, "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() > DESCRIPTION_LENGTH_LIMIT) {
            C1052b.m7515b(TAG, "checkArgs fail, description is invalid");
            return false;
        } else if (this.mediaObject == null) {
            C1052b.m7515b(TAG, "checkArgs fail, mediaObject is null");
            return false;
        } else if (this.mediaTagName != null && this.mediaTagName.length() > 64) {
            C1052b.m7515b(TAG, "checkArgs fail, mediaTagName is too long");
            return false;
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            e.printStackTrace();
            C1052b.m7515b(TAG, "put thumb failed");
        }
    }
}
