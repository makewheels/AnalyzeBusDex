...
public class WebChromeClient {
    ...
    public static abstract class FileChooserParams extends android.webkit.WebChromeClient.FileChooserParams {
        ...
        public static Uri[] parseResult(int i, Intent intent) {
            try {
                ...
                if (a != null && a.m7858b()) {
                    return a.m7852a().m7781a(i, intent);
                }
                Object a2 = C1157u.m8040a(Class.forName("com.android.webview.chromium.FileChooserParamsAdapter"), "parseFileChooserResult", new Class[]{Integer.TYPE, Intent.class}, Integer.valueOf(i), intent);
